...
@section('back_url',route('user.send_password'))
@php
    $has_basket = false;
@endphp
@section('content')
        ...
        <div class="gray-box">
            <div class="default-full-container gray-container">
                ...
                <div class="main-form-box">
                    ...
                    <div class="form-group-box confrim-input-box">
                        <input type="text" class="input-control " name="confirm_code" placeholder="کد ارسال شده"
                               maxlength="11">
                    </div>
                    <div class="form-group-box confrim-input-box">
                        <input type="password" class="input-control " name="password" placeholder="رمز عبور جدید"
                               maxlength="11">
                    </div>
                    <div class="form-group-box confrim-input-box">
                        <input type="password" class="input-control " name="confirm_password" placeholder="تکرار رمز عبور"
                               maxlength="11">
                    </div>
