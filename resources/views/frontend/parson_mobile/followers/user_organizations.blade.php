...
@section('description','')
@section('open_graph')
    <meta property='og:site_name' content='ناشران'>
            ...
            <div class="kethab-category-container container">
                ...
                <div class="category-books-main profile-main col-md-9 col-12">
                    ...
                    <div
                            ...
                            @foreach($followOrganizations as $followOrganization)
                                <div class="writer-books-col col-lg-2 col-4 ">
                                    <div class="books-col-image">
                                        <img src="{{ getOrganizationImagePath($followOrganization->organization->thumbnail) }}" alt="{{ $followOrganization->organization->title }}">
                                    </div>
                                    <div class="book-info-box">
                                        <h2 class="writer-title"><a href="{{ route('organization.view',[$followOrganization->organization->id,$followOrganization->organization->slug]) }}">
                        ...
                        {{ $followOrganizations->appends($_GET)->links(currentFrontView('pagination')) }}
                    </div>
