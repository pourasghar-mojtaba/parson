...
<script>
    ...
    function addReportComment() {
        ...
        $.ajax({
            url: '{{ route("blogcommentreport.add") }}',
            type: 'post',
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",
