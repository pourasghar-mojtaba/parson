...
Route::match(array('GET', 'POST'), 'users/new_password', ['as' => 'user.new_password', 'uses' => 'UsersController@new_password']);
Route::post('users/send_password', ['as' => 'user.send_password', 'uses' => 'UsersController@send_password']);

Route::get('users/chat', ['as' => 'user.chat', 'uses' => 'UsersController@chat']);
Route::post('users/send-message',['as' => 'user.send.message', 'uses' => 'UsersController@send-message']);
